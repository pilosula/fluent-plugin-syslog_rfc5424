...
class RFC5424::FormatterTest < Test::Unit::TestCase
  ...
  def test_with_timestamp_utc_plus_8
    log = RFC5424::Formatter.format(timestamp: 0, timezone_offset: 28800, log: "test-log")
  ...
  def test_with_timestamp_nano_utc_plus_8
    log = RFC5424::Formatter.format(timestamp: Fluent::EventTime.new(0, 123456000), timezone_offset: 28800, log: "test-log")
